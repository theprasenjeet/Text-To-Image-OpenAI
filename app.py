...
openai.api_key = os.environ.get('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')
...
st.markdown("<br><hr><center>Made with ❤️ by <a href='mailto:support@kartexa.com?subject=ChatGPT + DALL-E WebApp!&body=Please specify the issue you are facing with the app.'><strong>Prateek Ralhan</strong></a></center><hr>", unsafe_allow_html=True)
